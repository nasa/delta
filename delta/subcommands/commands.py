...
def setup_classify(subparsers):
    ...
    # DONE: change/remove errors and add boolean abs_error option
    sub.add_argument('--error', dest='error', action='store_true', help='Save image of model errors. Values will be difference between predicted probability and the binary labels.')
    sub.add_argument('--error-abs', dest='error_abs', action='store_true', help='Save image of absolute value of model errors. Values will be the absolute value of the difference between predicted probability and binary label. If both --error and --error-abs are provided, --error-abs will take precidence.')
